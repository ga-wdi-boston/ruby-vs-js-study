...
```md
<!--
${ }  is used for string interpolation JS, while #{ } is used for string interpolation in Ruby

JS uses camelCase, while Ruby uses snake_case

JS uses objects, while "objects" n Ruby are called hashes
 -->
```
...
console.log(`Many people like to drink ${beverage}.`)
...
```javascript
//
let person = function initialize(name) {
  this.name = name
}
const hello = function() {
    console.log('Hello, my name is {$this.name}.')
}
person = new person('Jeff Boomhauer')
