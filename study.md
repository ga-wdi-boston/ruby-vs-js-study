...
```md
- Ruby does not use incremental operators like i++ instead it uses +=i
- Ruby does not use { }; to end a code block, instead it uses end
- To console.log/return things in ruby you use puts instead.
```
