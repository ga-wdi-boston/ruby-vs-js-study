...
```md
Ruby: 1. Uses snake_case
      2. Uses 'puts' to display code in the console
      3. You can comment out ruby code with '#'
JavaScript: 1. Uses camelCase
            2. Uses console.log to display the output of code.
            3. You can comment out javascipt code with '//'
