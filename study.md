...
```md
Ruby has several different numeric types whehreas js only has one
Ruby does not need parentheses when invoking a method
JS is camelcase naming convention and ruby is snakecase```
