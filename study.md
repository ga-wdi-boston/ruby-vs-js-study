...
```md
* You don't need const or let when declaring variables in Ruby
* The keyword for declaring a method in Ruby is "def", in Javascript it would be "function() or ()=>"
* You cannot use dot notation when accessing hash properties in Ruby
* You dont need parens when calling a Ruby method
```
